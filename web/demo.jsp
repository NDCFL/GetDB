...
<head>
    ...
    <link rel='Shortcut Icon' type='image/x-icon' href='<%=path%>/static//img/windows.ico'>
    <script type="text/javascript" src="<%=path%>/static//js/jquery-2.2.4.min.js"></script>
    <link href="<%=path%>/static//css/animate.css" rel="stylesheet">
    <script type="text/javascript" src="<%=path%>/static//component/layer-v3.0.3/layer/layer.js"></script>
    <link rel="stylesheet" href="<%=path%>/static//component/font-awesome-4.7.0/css/font-awesome.min.css">
    <link href="<%=path%>/static//css/default.css" rel="stylesheet">
    <script type="text/javascript" src="<%=path%>/static//js/win10.js"></script>
    <style>
        * {
    ...
    <script>
        Win10.onReady(function () {
            ...
            //设置壁纸
            Win10.setBgUrl({
                main:'<%=path%>/static//img/wallpapers/main.jpg',
                mobile:'<%=path%>/static//img/wallpapers/mobile.jpg',
            });
...
<div id="win10">
    <div class="desktop">
        <div id="win10-shortcuts" class="shortcuts-hidden">
            <div class="shortcut" onclick="Win10.openUrl('http://win10ui.yuri2.cn','<img class=\'icon\' src=\'<%=path%>/static//img/icon/win10.png\'/>Win10-UI官网')">
                <img class="icon" src="./img/icon/win10.png"/>
                <div class="title">Win10-UI官网</div>
            </div>
            <div class="shortcut" onclick="Win10.openUrl('https://yuri2.cn','<img class=\'icon\' src=\'<%=path%>/static//img/icon/blogger.png\'/>尤里2号的博客')">
                <img class="icon" src="./img/icon/blogger.png"/>
                <div class="title">Yuri2's Blog</div>
            </div>
            <div class="shortcut" onclick="Win10.openUrl('win10ui.yuri2.cn/src/doc.php','<img class=\'icon\' src=\'<%=path%>/static//img/icon/doc.png\'/>在线文档')">
            ...
            <div class="shortcut" onclick="Win10.openUrl('https://www.oschina.net/p/win10-ui','<img class=\'icon\' src=\'<%=path%>/static//img/icon/kyzg.png\'/>开源中国（求支持~）')">
            ...
            <div class="shortcut" onclick='Win10.openUrl("<%=path%>/static//login.html","<i class=\"fa fa-user icon black-green\"></i>示例登录页")'>
    ...
    <div id="win10-menu" class="hidden">
        <div class="list win10-menu-hidden animated animated-slideOutLeft">
            ...
            <div class="sub-item" onclick="Win10.openUrl('child.jsp','子页')">父子页沟通</div>
